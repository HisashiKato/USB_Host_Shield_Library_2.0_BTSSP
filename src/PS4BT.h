/* Copyright (C) 2021 Kristian Sloth Lauszus. All rights reserved.
 ...
 Modified 14 Feb 2022 by HisashiKato
 ...
 */
class PS4BT : public BTHIDs, public PS4Parser {
public:
        /**
         ...
         */
        PS4BT(BTDSSP *p, bool pair = false) :
        BTHIDs(p, pair) {
                PS4Parser::Reset();
        };
...
protected:
        ...
        virtual void sendOutputReport(PS4Output *output) {
              ...
              //buf[6] = 0x00;
                ...
                // The PS4 console actually set the four last bytes to a CRC32 checksum.
                ...
                BTHIDs::sendReport(buf, sizeof(buf));
